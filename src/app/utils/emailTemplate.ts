...
export const OTPmailBody = (value: number) => {
  ...
  <div style="width: 100%; max-width: 600px; margin: 0 auto; padding: 20px; background-color: #fff; border-radius: 10px; box-shadow: 0 0 10px rgba(0,0,0,0.1);">
    ...
    <div style="text-align: center;">
      <p style="color: #555; font-size: 16px; line-height: 1.5; margin-bottom: 20px;">Your single use code is:</p>
      <div style="background-color: #277E16; width: 100px; padding: 12px 0; text-align: center; border-radius: 8px; color: #fff; font-size: 28px; font-weight: bold; letter-spacing: 3px; margin: 20px auto;">
        ${value}
      </div>
      <p style="color: #555; font-size: 16px; line-height: 1.5; margin-bottom: 20px;">This code is valid for <strong>3 minutes</strong>.</p>
